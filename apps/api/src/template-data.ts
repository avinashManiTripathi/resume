// 10 Professional Resume Templates for Template Model
// Each template maintains data attributes for compatibility with existing logic
...
export const RESUME_TEMPLATES = [
    {
        ...
        isActive: true,
        sortOrder: 1,
        tags: ["professional", "classic", "traditional", "ats-friendly"],
...
<body>
  <main id="resume-root" class="max-w-4xl mx-auto bg-white p-8">
...

    {
        ...
        isActive: true,
        sortOrder: 2,
        tags: ["modern", "two-column", "sidebar", "tech"],
        htmlContent: `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
...
// Note: This file contains 2 templates as an example. 
// You can add 8 more templates following the same structure.
// Each template should have unique name, proper data attributes, and maintain compatibility with existing logic.
