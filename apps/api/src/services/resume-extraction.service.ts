...

{
  ...
  "summary": {
    "content": "string (2-3 sentences highlighting key strengths, years of experience, core expertise, and value proposition with quantifiable achievements - ATS-optimized with keywords)"
  },
  "experience": [
    {
...
Now extract and structure the resume data:`;
  ...
  private validateAndCleanData(data: any): ResumeData {
    ...
    const cleanData: ResumeData = {
      ...
      summary: {
        content: data.summary?.content || data.personalInfo?.summary || ''
      },
